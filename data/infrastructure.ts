...
// Full-screen vertical renders (lie in /public/images/infra/*.jpg).
// Shown one by one inside the opened elevator doorway.
export const infraItems: InfraItem[] = [
  {
    number: "01",
    icon: "cart",
    image: "/images/infra/supermarket.jpg",
    title: "Супермаркет",
  ...
  },
  {
    number: "03",
    icon: "dumbbell",
    image: "/images/infra/fitness.jpg",
    title: "Фитнес",
  ...
  },
  {
    number: "04",
    icon: "waves",
    image: "/images/infra/pool-spa.jpg",
    title: "Бассейн и спа",
  ...
  },
  {
    number: "06",
    icon: "cross",
    image: "/images/infra/pharmacy.jpg",
    title: "Аптека",
  ...
  },
  {
    number: "08",
    icon: "washer",
    image: "/images/infra/laundry.jpg",
    title: "Химчистка",
  ...
  },
  {
    number: "09",
    icon: "parking",
    image: "/images/infra/parking.jpg",
